					...
					<div class="card" style="direction:rtl">
                     ...
                     <div class="body" >
                        <form method="Post" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                  الجنس:
                                    <label class="fancy-radio custom-color-green"><input name="gender" value="ذكر`" type="radio" checked><span><i></i>Male</span></label>
                                    <label class="fancy-radio custom-color-green"><input name="gender" value="أنثى" type="radio"><span><i></i>Female</span></label>
                                    @error('gender')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
